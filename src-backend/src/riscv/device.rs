...
use titan::riscv::assembler::registers::RegisterSlot::{GlobalPointer, StackPointer};
use titan::riscv::cpu::registers::WhichRegister::Pc;
use titan::riscv::cpu::{Memory, Registers, State};
...
pub fn setup_state<Mem: Memory + Mountable, Reg: Registers>(state: &mut State<Mem, Reg>) {
    ...
    state.registers.set_l(GlobalPointer, 0x10008000);
