  ...
  return {
    ...
    options: [
      ...
      ...[
        ...
        { detail: 'Floor Floating Point Single to Integer', label: 'floor.w.s' },
        { detail: 'Ceil Floating Point Single to Integer', label: 'ceil.w.s' },
        { detail: 'Round Floating Point Single to Integer', label: 'round.w.s' },
        { detail: 'Truncate Floating Point Single to Integer', label: 'trunc.w.s' },
        ...
        { detail: 'Floor Floating Point Double to Integer', label: 'floor.w.d' },
        { detail: 'Ceil Floating Point Double to Integer', label: 'ceil.w.d' },
        { detail: 'Round Floating Point Double to Integer', label: 'round.w.d' },
        { detail: 'Truncate Floating Point Double to Integer', label: 'trunc.w.d' },
        { detail: 'Compare Equal Floating Point Single to Integer', label: 'c.eq.s' },
        ...
        { detail: 'Convert to Floating Point Single from Integer', label: 'cvt.s.w' },
        { detail: 'Convert to Floating Point Single from Double', label: 'cvt.s.d' },
        { detail: 'Convert to Integer from Floating Point Single', label: 'cvt.w.s' },
        { detail: 'Convert to Floating Point Double from Single', label: 'cvt.d.s' },
        { detail: 'Convert to Floating Point Double from Integer', label: 'cvt.d.w' },
        { detail: 'Convert to Integer from Floating Point Double', label: 'cvt.w.d' },
