  ...
  if (word.text.startsWith('$')) {
    return {
      ...
      options: [
        ...
        { detail: 'Floating Point 0', label: '$f0' },
        { detail: 'Floating Point 1', label: '$f1' },
        { detail: 'Floating Point 2', label: '$f2' },
        { detail: 'Floating Point 3', label: '$f3' },
        { detail: 'Floating Point 4', label: '$f4' },
        { detail: 'Floating Point 5', label: '$f5' },
        { detail: 'Floating Point 6', label: '$f6' },
        { detail: 'Floating Point 7', label: '$f7' },
        { detail: 'Floating Point 8', label: '$f8' },
        { detail: 'Floating Point 9', label: '$f9' },
        { detail: 'Floating Point 10', label: '$f10' },
        { detail: 'Floating Point 11', label: '$f11' },
        { detail: 'Floating Point 12', label: '$f12' },
        { detail: 'Floating Point 13', label: '$f13' },
        { detail: 'Floating Point 14', label: '$f14' },
        { detail: 'Floating Point 15', label: '$f15' },
        { detail: 'Floating Point 16', label: '$f16' },
        { detail: 'Floating Point 17', label: '$f17' },
        { detail: 'Floating Point 18', label: '$f18' },
        { detail: 'Floating Point 19', label: '$f19' },
        { detail: 'Floating Point 20', label: '$f20' },
        { detail: 'Floating Point 21', label: '$f21' },
        { detail: 'Floating Point 22', label: '$f22' },
        { detail: 'Floating Point 23', label: '$f23' },
        { detail: 'Floating Point 24', label: '$f24' },
        { detail: 'Floating Point 25', label: '$f25' },
        { detail: 'Floating Point 26', label: '$f26' },
        { detail: 'Floating Point 27', label: '$f27' },
        { detail: 'Floating Point 28', label: '$f28' },
        { detail: 'Floating Point 29', label: '$f29' },
        { detail: 'Floating Point 30', label: '$f30' },
        { detail: 'Floating Point 31', label: '$f31' },
  ...
  return {
    ...
    options: [
      ...
      ...[
        ...
        { detail: 'Branch on Floating Point True', label: 'bc1t' },
        { detail: 'Branch on Floating Point False', label: 'bc1f' },
        { detail: 'Add Floating Point Single', label: 'add.s' },
        { detail: 'Subtract Floating Point Single', label: 'sub.s' },
        { detail: 'Multiply Floating Point Single', label: 'mul.s' },
        { detail: 'Divide Floating Point Single', label: 'div.s' },
        { detail: 'Square Root Floating Point Single', label: 'sqrt.s' },
        {
          detail: 'Floor Floating Point Single to Integer',
          label: 'floor.w.s',
        },
        { detail: 'Ceil Floating Point Single to Integer', label: 'ceil.w.s' },
        {
          detail: 'Round Floating Point Single to Integer',
          label: 'round.w.s',
        },
        {
          detail: 'Truncate Floating Point Single to Integer',
          label: 'trunc.w.s',
        },
        { detail: 'Add Floating Point Double', label: 'add.d' },
        { detail: 'Subtract Floating Point Double', label: 'sub.d' },
        { detail: 'Multiply Floating Point Double', label: 'mul.d' },
        { detail: 'Divide Floating Point Double', label: 'div.d' },
        { detail: 'Square Root Floating Point Double', label: 'sqrt.d' },
        {
          detail: 'Floor Floating Point Double to Integer',
          label: 'floor.w.d',
        },
        { detail: 'Ceil Floating Point Double to Integer', label: 'ceil.w.d' },
        {
          detail: 'Round Floating Point Double to Integer',
          label: 'round.w.d',
        },
        {
          detail: 'Truncate Floating Point Double to Integer',
          label: 'trunc.w.d',
        },
        {
          detail: 'Compare Equal Floating Point Single to Integer',
          label: 'c.eq.s',
        },
        { detail: 'Compare <= Floating Point Single', label: 'c.le.s' },
        { detail: 'Compare < Floating Point Single', label: 'c.lt.s' },
        { detail: 'Compare == Point Double', label: 'c.eq.d' },
        { detail: 'Compare <= Floating Point Double', label: 'c.le.d' },
        { detail: 'Compare < Floating Point Double', label: 'c.lt.d' },
        { detail: 'Absolute Value Floating Point Single', label: 'abs.s' },
        { detail: 'Negate Floating Point Single', label: 'neg.s' },
        { detail: 'Absolute Value Floating Point Double', label: 'abs.d' },
        { detail: 'Negate Floating Point Double', label: 'neg.d' },
        { detail: 'Move Floating Point Single', label: 'mov.s' },
        { detail: 'Move Floating Point Single on True', label: 'movt.s' },
        { detail: 'Move Floating Point Single on False', label: 'movf.s' },
        { detail: 'Move Floating Point Single on Not Zero', label: 'movn.s' },
        { detail: 'Move Floating Point Single on Zero', label: 'movz.s' },
        { detail: 'Move Floating Point Double', label: 'mov.d' },
        { detail: 'Move Floating Point Double on True', label: 'movt.d' },
        { detail: 'Move Floating Point Double on False', label: 'movf.d' },
        { detail: 'Move Floating Point Double on Not Zero', label: 'movn.d' },
        { detail: 'Move Floating Point Double on Zero', label: 'movz.d' },
        {
          detail: 'Convert to Floating Point Single from Integer',
          label: 'cvt.s.w',
        },
        {
          detail: 'Convert to Floating Point Single from Double',
          label: 'cvt.s.d',
        },
        {
          detail: 'Convert to Integer from Floating Point Single',
          label: 'cvt.w.s',
        },
        {
          detail: 'Convert to Floating Point Double from Single',
          label: 'cvt.d.s',
        },
        {
          detail: 'Convert to Floating Point Double from Integer',
          label: 'cvt.d.w',
        },
        {
          detail: 'Convert to Integer from Floating Point Double',
          label: 'cvt.w.d',
        },
        { detail: 'Move to Floating Point Control Register', label: 'mtc1' },
        { detail: 'Move from Floating Point Control Register', label: 'mfc1' },
        { detail: 'Load Word to Floating Point Register', label: 'lwc1' },
        { detail: 'Store Word to Floating Point Register', label: 'swc1' },
        { detail: 'Load Double to Floating Point Register', label: 'ldc1' },
        { detail: 'Store Double to Floating Point Register', label: 'sdc1' },
